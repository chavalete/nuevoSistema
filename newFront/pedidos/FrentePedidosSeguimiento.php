...
class FrentePedidosSeguimiento
{
    ...
    public function consultarPedidos ($arrParametros){
        ...
        $this->_db->addSelect('pedido_id,pedido_nro, to_char(fecha_hora,\'DD-MM-YYYY HH24:MI\') AS fecha_hora,cliente_nombre,estado_desc');
	...
	//**ANALIZO EL WHERE**//
        ...
        if($arrParametros['pedidos'] !=null ){
            $this->_db->addWhere('pedido_nro = \'' . $arrParametros['pedidos'] . '\' ');
        }
        //**fin where **/
        //**INICIO ORDER BY**//
        //*seteo el orden*/
