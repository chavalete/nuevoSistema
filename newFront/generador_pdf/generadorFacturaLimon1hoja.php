...
$db->addSelect('CASE WHEN df.lista_id = 10 THEN \'Efectivo\' ELSE \'Tarjeta\' END AS forma_pago');
...
$pdf->AddPage();                          
//DATOS PROPIOS
$pdf->Image('limon.jpeg', 5, 5, 65, 20, 'jpeg');
...
$pdf->Text(30,30, utf8_decode("Limón Autoservicio Mayorista"));
$pdf->Text(40,34, utf8_decode(" Av Gaona 901 - "));
$pdf->Text(5,38, utf8_decode("Moreno, Buenos Aires "));
$pdf->Text(23,42, utf8_decode("1171917939"));
...
$pdf->Text(5,68, utf8_decode("Forma de pago: "));
...
$pdf->Text(35,68, utf8_decode($arrCabecera[0]['forma_pago'])) ;
