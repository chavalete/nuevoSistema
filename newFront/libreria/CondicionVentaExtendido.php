<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/newFront/libreria/libreria/CondicionVenta.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/newFront/libreria/almacenamiento/FrenteAlmacenamiento.php';
/*
CLASE DE CATEGORIAS
*/

class CondicionVentaExtendido extends CondicionVenta
{
    private $_condicionVentaActivoMensaje;
    private $_condicionVentaActivoDesc;
    private $_condicionVentaNoActivoDesc;
    
    public function __construct(){
	$this->_db = new FrenteAlmacenamiento('dmelmac');
    }
    
    public function setCondicionVentaActivoDesc($condicion_ventaActivoDesc){
	$this->_condicion_ventaActivoDesc = $condicion_ventaActivoDesc;
    }
    public function getCondicionVentaActivoDesc(){
	return $this->_condicionVentaActivoDesc;
    }
    public function setCondicionVentaNoActivoDesc($condicion_ventaNoActivoDesc){
	$this->_condicionVentaNoActivoDesc = $condicion_ventaNoActivoDesc;
    }
    public function getCondicionVentaNoActivoDesc(){
	return $this->_condicionVentaNoActivoDesc;
    }
    public function setCondicionVentaActivoMensaje($condicion_ventaActivoMensaje){
	$this->_condicionVentaActivoMensaje= $condicion_ventaActivoMensaje;
    }
    public function getCondicionVentaActivoMensaje(){
	return $this->_condicionVentaActivoMensaje;
    }
	...
	$this->_db->addSelect('condicion_venta_nombre');
	...
	$this->_db->addWhere('condicion_venta_id = \'' . $id .'\'' );
	...
	$this->setCondicionVentaId($resultado['condicion_venta_id']);
	$this->setCondicionVentaNombre($resultado['condicion_venta_nombre']);
	$this->setObs($resultado['observaciones']);
	$this->setCondicionVentaActivoDesc($resultado['condicion_venta_activo_desc']);
	$this->setCondicionVentaNoActivoDesc($resultado['condicion_venta_no_activo_desc']);
	$this->setCondicionVentaActivoMensaje($resultado['condicion_venta_activo_mensaje']);
	$this->setCondicionVentaActiva($resultado['condicion_venta_activo']);
	$this->setCondicionVentaNombre($resultado['condicion_venta_nombre']);
