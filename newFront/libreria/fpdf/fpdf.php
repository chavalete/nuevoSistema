...
function SetDisplayMode($zoom, $layout='continuous')
{
	...
	if($zoom=='fullimonMorenoage' || $zoom=='fullwidth' || $zoom=='real' || $zoom=='default' || !is_string($zoom))
		$this->ZoomMode=$zoom;
	else
...
function _parsepng($file)
{
	...
	elseif($ct==3)
		...
		$this->Error('AlimonMorenoha channel not supported: '.$file);
...
function _putcatalog()
{
	...
	if($this->ZoomMode=='fullimonMorenoage')
