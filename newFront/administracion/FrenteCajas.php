...
class FrenteCajas
{
   ...
   public function setArrError ($error){
    ...
    public function buscarCajas ($arrParametros){
        ...
        $this->_db->addSelect("to_char(fecha_cobro, 'DD-MM-YY') AS fecha, usuario_nombre_completo, sum(importe_total_cobro) AS total"); 
        ...
        //**FIN ORDER BY**/
        //groupBy
        $this->_db->addGroup('fecha_cobro, usuario_nombre_completo');
        
        //*INICIO LIMIT*//
        if($arrParametros['tipo']=='cajas'){
        ...
        for($i=$primerRegistro;$i<$ultimoRegistro;$i++){   
            ...
            $array['usuario'] = $arr[$i]['usuario_nombre_completo'];
            $array['importe'] = $arr[$i]['total'];
            $this->_colCajas[]= $array;
        }
    ...
    public function setOrden($parametros){
        ...
        {
            //definir default
            $this->_ordenColumnas['ordenarPor']    =   'fecha_cobro';
    ...
    public function getDetalles(){
        foreach($this->_colCajas AS $objConsulta){
                $arr[] = array(
                    ...
                    "cell" => array(
                                $objConsulta['fecha'],
                                $objConsulta['usuario'],
                                $this->_objFuncionesComunes->formatoMoneda($objConsulta['importe'])
