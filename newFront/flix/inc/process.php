...
//var_dump($_REQUEST);exit;
	...
	$_REQUEST['id'];
		...
		break;
	case 'estadoDeDeuda':
            $url= "http://45.33.26.30/limonLocal/exportador/exportadorEstadoCuenta.php?idCliente=".$_REQUEST['id'];
            //echo $url;exit;
            $arrDevolver = array(
                                    "soyError" => false,
                                    "nivel" => 1,
    ...
    case 'cobros':
		$url= "http://45.33.26.30/limonLocal/generador_pdf/generadorOrdenCobro.php?crIdCobro=".$_REQUEST['id'];
		//echo $url;exit;
		$arrDevolver = array(
                                  "soyError" => false,
                                  "nivel" => 1,
		...
		break;
    case 'totales':
		$url= "http://45.33.26.30/limonLocal/generador_pdf/generadorReporteTotales.php?crIdCobro=".$_REQUEST['id'];
		//echo $url;exit;
		$arrDevolver = array(
                                  "soyError" => false,
                                  "nivel" => 1,
		...
		break;
    case 'ordenes':
		$url= "http://45.33.26.30/limonLocal/generador_pdf/generadorOrdenGuia.php?crIdGuia=".$_REQUEST['id'];
		//echo $url;exit;
		$arrDevolver = array(
                                  "soyError" => false,
                                  "nivel" => 1,
	...
	case 'entradas':		
		$url= "http://45.33.26.30/limonLocal/generador_pdf/impresionEtiquetaEstandar.php?crIdMovimiento=".
$_REQUEST['id'];
	...
	case 'listadoDePendientes':
                $url= "http://45.33.26.30/limonLocal/generador_pdf/generador_remito_sh.php?crIdMovimiento=".
$_REQUEST['id'];
	...
	case 'busquedaPorCodigo':
		...
		$url= "http://45.33.26.30/limonLocal/generador_pdf/impresionEtiqueta.php?crIdTrazabilidad=".
$_REQUEST['id'];
        ...
        $url = "http://45.33.26.30/limonLocal/generador_pdf/manejadorFacturaLimon.php?" . http_build_query($params);
		...
		break;
		case 'facturas':
		$url= "http://45.33.26.30/limonLocal/generador_pdf/manejadorFacturaLimon.php?crIdFactura=".
$_REQUEST['id'];
		...
		break;
        case 'pedidos':
		$url= "http://45.33.26.30/limonLocal/generador_pdf/generadorHojaPedido.php?crPedidoId=".
$_REQUEST['id'];
		...
		break;
	case 'hojaDeRuta':
		$url= "http://45.33.26.30/limonLocal/generador_pdf/generadorDetalleHojaRuta.php?crHojaId=".
$_REQUEST['id'];
		...
		break;
    case 'liquidaciones':
		$url= "http://45.33.26.30/limonLocal/generador_pdf/generadorLiquidacion.php?crIdLiquidacion=".
$_REQUEST['id'];
        ...
        case 'pedidos':
	default:
		$url= "http://45.33.26.30/limonLocal/generador_pdf/generadorDetalleEntrada.php?crIdMovimiento=".
...
die();
*/
require_once $_SERVER['DOCUMENT_ROOT'] . '/limonLocal/modelo/frenteDeFrentes.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/limonLocal/usuarios/FrenteUsuarios.php';
