...
<script type="text/javascript">
    $('div.send-button.exportarStock').click(function(){
        ...
        if($('input#error', 'div#modal.inicio').val() == '0'){
            $.colorbox.close();
            window.open("http://172.104.5.168/newFront/exportador/exportadorMayor.php?accion=hacerAlta&tipoReporte="+tipoReporte+"&fechaHasta="+fechaHasta+"&fechaDesde="+fechaDesde+"&relacionId="+relacion+"&ordenNro="+ordenNro+"&facturas="+facturas+"&idVendedor=11&&idCliente="+cliente, "_blank");
