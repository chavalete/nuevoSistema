    ...
    <div class="modal_content">
        <table>
			...
			<tr>
                ...
                <td class="secundary" style="display: none; width: 700px; vertical-align: top;">
                    <div id="codigos">
                        <table id="codigos" align="left" style="width: 450px;">
                            <thead>
                                <tr>
            ...
            if(e.keyCode == 13 && $(this).val().trim() != ''){
                ...
                $.post(
                    ...
                    function(data){
                        ...
                        $('td.codigo_inserted', tr).attr('datamatrix', data.valor);
                        //$('td.valor', tr).html(data.valor);
