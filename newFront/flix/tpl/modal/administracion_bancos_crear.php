<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Alta de Bancos</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <table id="abmCrear">
            ...
            <tr>
                ...
                <td class="field-input"><input class="required" type="text" name="bancoNombre" /></td>
            </tr>
        </table>
    ...
    var abmCrear = function(){
        ...
        $.post(
            ...
            {   
                accion     : 'hacerAlta',
                parametros : {
                    bancoNombre    : $('input[name=bancoNombre]', 'table#abmCrear').val(),
                    desdeAlta     : false,
