<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Exportar Entradas </span>
        <!-- Tooltip -->
        <div class='tooltip'>
...
<script type="text/javascript">
        ...
        if($('input#error', 'div#modal.inicio').val() == '0'){
            ...
            $.colorbox.close();
            window.open(window.urlServices + "exportador/exportadorEntradas.php?accion=hacerAlta&idProveedor="+proveedores+"&vendedores="+vendedores+"&bonificacion="+bonificacion+"&cuentaId="+cuenta+"&relacionId="+relacion+"&fechaDesde="+fechaDesde+"&fechaHasta="+fechaHasta+"&exportar="+exportar, "_blank");
	}
