<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Alta de lista de precios</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <table id="abmCrear">
            ...
            <tr>
                <td class="field-name"><span class="field-name">Lista Nombre</span></td>
                <td class="field-input"><input class="required" type="text" name="lista" /></td>
            </tr>
            <tr>
                <td class="field-name"><span class="field-name">Lista Padre</span></td>
    ...
    var abmCrear = function(){
        ...
        $.post(
            ...
            {   
                accion     : 'hacerAlta',
                parametros : {
                    lista    : $('input[name=lista]', 'table#abmCrear').val(),
                    listaPadreId       : $('input[name=listaDePrecios]').attr('params'),
                    desdeAlta     : false,
