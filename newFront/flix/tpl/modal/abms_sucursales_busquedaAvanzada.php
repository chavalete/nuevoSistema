<div id="modal">
    <div class="modal_title">
        <span class="title">Busqueda avanzada de sucursales</span>
        <!-- Inicio de la Tooltip -->    
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <input type="hidden" name="tipo" value="sucursales" />
        <table>
            <tr>
                <td class="field-name"><span class="field-name">Sucursal</span></td>
                <td class="field-input"><input type="text" name="sucursales" class="autocomplete"/></td>
            </tr>
        </table>
