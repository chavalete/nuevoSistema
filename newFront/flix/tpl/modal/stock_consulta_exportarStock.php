...
<script type="text/javascript">
    $('div.send-button.exportarStock').click(function(){
        ...
        if($('input#error', 'div#modal.inicio').val() == '0'){
            $.colorbox.close();
            window.open("http://localhost/limonLocal/exportador/exportadorStock.php?accion=hacerAlta&idSucursal="+idSucursal+"&fechaHasta="+fechaHasta+"&fechaDesde="+fechaDesde+"&subfamilias="+subfamilias+"&marcas="+marcas+"&idProducto="+productos+"&idFamilia="+familia+"&ordenadoPor="+ordenadoPor, "_blank");
        }
    });
</script>
