<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Saldo inicio</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <table id="abmCrear">
            ...
            <tr>
                <td class="field-name"><span class="field-name">Saldo</span></td>
                <td class="field-input"><input class="required" type="text" name="saldo" /></td>
            </tr>
        </table>
    ...
    var abmCrear = function(){
        ...
        $.post(
            ...
            {   
                accion     : 'hacerAlta',
                parametros : {
                    saldo    : $('input[name=saldo]', 'table#abmCrear').val(),
                    cliente    : $('input[name=clientes]', 'table#abmCrear').attr('params'),
                    desdeAlta     : false,
                    tipo          : 'mayor'
                }
            }, 
