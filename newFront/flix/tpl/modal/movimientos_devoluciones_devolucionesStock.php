    ...
    <div class="modal_title">
        ...
        <div class='tooltip'>
            <div class="tooltip-position" style='right: 30px; float: right;'>
                ...
                <div class="tooltip-content" params="devoluciones" style="top: 30px; left: -300px; width: 320px; height: 365px;"></div>
            </div>
        </div>
        <!-- Fin de la Tooltip -->
    </div>
...
<div id="modal" class="resumen" style="display: none">
    <div class="modal_title"><span class="title"> Devolucion -  Resumen</span></div>
...
<script type="text/javascript">
    ...
    $('input[name=cantidad]').live('keypress', function(e){
        var keyCode = e.which;    
        if(keyCode == 13){
            hacerAlta();
        }
    ...
    $('div.send-button.resumenAltaStock').click(function(){
            ...
            if($('input#error', 'div#modal.inicio').val() == '0'){
                ...
                $('td.cabecera-detalle-blue.descuento').html($('input[name=descuento').val());
    ...
    $('div.hacerAltaStock').click(function(){
        ...
        var params = {
            ...
            facturas          : $('input[name=facturas]').attr('params'),
            remitos          : $('input[name=facturas]').val(),
