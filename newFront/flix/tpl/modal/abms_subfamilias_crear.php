<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Alta de subfamilia de productos</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <table id="abmCrear">
            ...
            <tr>
                ...
                <td class="field-input"><input class="required" type="text" name="subFamiliaNombre"/></td>
            </tr>
            <tr>
    ...
    var abmCrear = function(){
        $.post(
            ...
            {   
                accion     : 'hacerAlta',
                parametros : {
                    subFamiliaNombre     : $('input[name=subFamiliaNombre]', 'table#abmCrear').val(),
                    desdeAlta     : false,
