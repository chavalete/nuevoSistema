...
<script type="text/javascript">
    $('div.send-button.exportarStock').click(function(){
        ...
        if($('input#error', 'div#modal.inicio').val() == '0'){
            $.colorbox.close();
            window.open("http://172.104.5.168/newFront/exportador/exportadorEstadoCuenta.php?accion=hacerAlta&tipoReporte="+tipoReporte+"&idRelacion="+relacion+"&idVendedor="+vendedor+"&idCliente="+cliente, "_blank");
        }        
    });
</script>
