    ...
    <div class="modal_content">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="field-input"><input class="autocomplete" type="text" name="relaciones"/></td>
            </tr>
            <tr>
                <td class="field-name"><span class="field-name">Vendedor</span></td>
                <td class="field-input"><input class="autocomplete" type="text" name="vendedores"/></td>
            </tr>
            <tr>
...
<script type="text/javascript">
    $('div.send-button.exportarStock').click(function(){
        ...
        if($('input#error', 'div#modal.inicio').val() == '0'){
            $.colorbox.close();
            window.open("http://172.104.5.168/limonLocal/exportador/exportadorEstadoCuenta.php?accion=hacerAlta&tipoReporte="+tipoReporte+"&idRelacion="+relacion+"&idVendedor="+vendedor+"&idCliente="+cliente, "_blank");
        }        
    });
</script>
