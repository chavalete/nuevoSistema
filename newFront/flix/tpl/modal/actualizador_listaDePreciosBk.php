                            ...
                            <tr>
                                <td colspan="3">
                                    <table class="parcial">
                                        ...
                                        <tr>
                                            <td class="field-name"><span class="field-name">Lista</span></td>
                                            <td class="field-input"><input type="text" class="autocomplete parcial required" name="listaDePrecios"/></td>
                                        </tr>
                                    </table>
                                <td>
                            </tr>
                        ...
                        <table id="listas" align="left" style="width: 700px; margin-left: 10px;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="detalles-titulo-dark">Lista.</th>
...
<script type="text/javascript">
    ...
    var showSecundary = function(){
        ...
        var tdLista = '<td params="'+$('input[name=listaDePrecios]').attr('params')+'">'+$('input[name=listaDePrecios]').val()+'</td>';
        ...
        tr = '<tr id="product_'+product_count+'" class="'+trClass+'">' +  tdProd +  tdPrecio + tdCosto + tdLista + tdSupr + '</tr>';
        trResumen = '<tr id="product_'+product_count+'" class="'+trClassResumen+'">' + tdProd + tdPrecio + tdCosto + tdLista +  '</tr>';
    ...
    var resetForm = function(){
        $('input[name=listas]').val('');
        $('input[name=listas]').attr('params', '');
