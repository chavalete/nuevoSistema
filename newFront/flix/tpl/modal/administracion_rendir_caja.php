...
<script type="text/javascript">
    $('div.send-button.exportarStock').click(function(){
        ...
        if($('input#error', 'div#modal.inicio').val() == '0'){
            $.colorbox.close();
            window.open("http://45.56.77.112/newFront/generador_pdf/generarRendicionCaja.php?accion=hacerAlta&fechaDesde="+fechaDesde+"&subfamilias="+subfamilias+"&marcas="+marcas+"&idProducto="+productos+"&idVendedor="+vendedor+"&idUsuario="+usuario, "_blank");
        }        
    });
</script>
