<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Rendir Caja</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        ...
        <table>
            <tr>
                <td class="field-name"><span class="field-name">Usuario</span></td>
                <td class="field-input"><input type="text" name="usuarios" class="autocomplete required"/></td>
            </tr>
            <tr>
...
<script type="text/javascript">
    $('div.send-button.exportarStock').click(function(){
        ...
        var usuario = $('input[name=usuarios]').attr('params');
        ...
        if($('input#error', 'div#modal.inicio').val() == '0'){
            $.colorbox.close();
            window.open("http://45.56.77.112/limonLocal/generador_pdf/generarRendicionCaja.php?accion=hacerAlta&fechaDesde="+fechaDesde+"&subfamilias="+subfamilias+"&marcas="+marcas+"&idProducto="+productos+"&idVendedor="+vendedor+"&idUsuario="+usuario, "_blank");
        }        
    });
</script>
