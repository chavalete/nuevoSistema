<div id="modal">
    <div class="modal_title">
        <span class="title">Busqueda avanzada de proveedores</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <input type="hidden" name="tipo" value="distribuidores" />
        <table>
            <tr>
                <td class="field-name"><span class="field-name">Nombre</span></td>
                <td class="field-input"><input type="text" name="distribuidores" class="autocomplete"/></td>
            </tr>
        </table>
