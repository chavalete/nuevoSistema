...
<script type="text/javascript">
    $('div.send-button.exportarStock').click(function(){
        ...
        if($('input#error', 'div#modal.inicio').val() == '0'){
            $.colorbox.close();
            window.open("http://172.104.5.168/limonLocal/exportador/exportadorEstadoCuenta.php??accion=hacerAlta&tipoReporte="+tipoReporte+"&idVendedor=11&idCliente="+cliente, "_blank");
        }        
    });
</script>
