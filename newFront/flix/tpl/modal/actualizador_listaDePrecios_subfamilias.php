                                ...
                                <td colspan="3">
                                    <table class="parcial">
                                        ...
                                        <tr>
                                            ...
                                            <td class="field-input"><input type="text" name="subfamilias" id="subfamilia" class="autocomplete"/></td>
                                        </tr>
                                        <tr>
...
<script type="text/javascript">
    ...
    var showSecundary = function(){
        ...
        var tdProd = '<td params="'+$('input[name=subfamilias]').attr('params')+'">'+$('input[name=subfamilias]').val()+'</td>';
        ...
        if($(this).val() != 1){
            {
                $.post(
                    ...
                    {   
                        accion  : 'traerDatos',
                        id      : $('input[name=subfamilias]').attr('params'),
                        tipo    : 'subfamilia'
                    }, 
                    function(data){
    ...
    $('div.eliminar', 'table#listas').live('click', function(){
        ...
        $('input[name=listaDePrecios]').keypress(function(e){
        if(e.which == 13){
    ...
    $('div.hacerAltaStock').click(function(){
        ...
        var params = {
            ...
            tipo              : 'actualizarListasSubfamilias'
        };
