<div id="modal">
    <div class="modal_title">
        <span class="title">Búsqueda avanzada de usuarios botones</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <input type="hidden" name="tipo" value="usuariosBotonera" />
        <table>
            <tr>
                <td class="field-name"><span class="field-name">Nombre de usuario</span></td>
                <td class="field-input"><input type="text" name="usuariosBotonera" class="autocomplete"/></td>
            </tr>
     </table>
