            ...
            <tr>
                <td class="primary">
                    <form class="modal">
                        ...
                        <table>
                        <tr>
                            <td class="field-name"><span class="field-name">Factura Fecha</span></td>
                            <td class="field-input"><input type="text" class="datePicker" name="facturaFecha" /></td>
                        </tr> 
                        <tr>
                            <td class="field-name"><span class="field-name">Factura Letra</span></td>
                            <td class="field-input"><input type="text" class="autocomplete required" name="facturaLetra"/></td>
                        </tr>
                        <tr>
                                ...
                                <td colspan="3">
                                    <table class="parcial">
                                        ...
                                        <tr>
                                            ...
                                            <td class="field-input"><input type="text" name="remitosPendientes" class="autocomplete parcial required"/></td>
                ...
                <td class="secundary" style="display: none; width: 720px; vertical-align: top;">
                    <div id="productos">
                        <table id="productos" align="left" style="width: 700px; margin-left: 10px;">
                            <thead>
                                <tr>
                                    <th class="detalles-titulo-dark">Nro Remito</th>
...
<div id="modal" class="resumen" style="display: none">
    <div class="modal_title"><span class="title">Alta de Factura - Resumen</span></div>
    
    <div class="modal_content">
        <div>
            <table style="width: 100%;">
                <tr>
                    <td class="cabecera-title-blue">Factura Feccha</td>
                    <td class="cabecera-detalle-blue facturaFecha"></td>
                </tr>
                <tr>
                    <td class="cabecera-title-blue">Factura</td>
                    <td class="cabecera-detalle-blue facturaLetra"></td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    var showSecundary = function(){
        ...
        var tdRemito= '<td params="'+$('input[name=remitosPendientes]').attr('params')+'">'+$('input[name=remitosPendientes]').val()+'</td>';
        ...
        tr = '<tr id="product_'+product_count+'" class="'+trClass+'">' + tdRemito + tdSupr + '</tr>';
        trResumen = '<tr id="product_'+product_count+'" class="'+trClassResumen+'">' + tdRemito + '</tr>';
    ...
    var resetForm = function(){
        ...
        $('input[name=remitosPendientes]').val('');
    }
    ...
    $('input[name=remitosPendientes]').live('keypress', function(e){
        var keyCode = e.which;    
        if(keyCode == 13){
            hacerAlta();
        }
    ...
    $('div.send-button.resumenAltaStock').click(function(){
        if(window.added < 1){
            ...
            if($('input#error', 'div#modal.inicio').val() == '0'){
                ...
                $('td.cabecera-detalle-blue.facturaFecha').html($('input[name=facturaFecha]').val());
                $('td.cabecera-detalle-blue.clientes').html($('input[name=clientes]').val());
                $('td.cabecera-detalle-blue.facturaLetra').html($('input[name=facturaLetra]').val());
    ...
    $('div.hacerAltaStock').click(function(){
        ...
        var params = {
            ...
            desdeAlta         : false,
            facturaFecha: $('input[name=facturaFecha]').val(),
            remitos         : productosSplited,
            clientes       : $('input[name=clientes]').attr('params'),
            facturaLetra       : $('input[name=facturaLetra]').attr('params'),
            observaciones          : $('input[name=observaciones]').val(),
            puestoVenta  : $('select[name=tipoMovimientoId]').val(),
            tipo              : 'facturas'
        };
