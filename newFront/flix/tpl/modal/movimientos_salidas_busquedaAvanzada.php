<div id="modal">
    <div class="modal_title">
        <span class="title">Busqueda avanzada de salidas</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <form class="modal">
            <input type="hidden" name="tipo" value="salidas" />
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="field-input"><input type="text" class="autocomplete" name="vendedoresClientes"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="field-input"><input type="text" class="autocomplete" name="estadosDos"/></td>
                </tr>
                <tr>
