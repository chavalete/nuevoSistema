<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Alta de almacenes</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <table id="abmCrear">
            ...
            <tr>
                ...
                <td class="field-input"><input class="required" type="text" name="almacenes"/></td>
            </tr>
            <tr>
                <td class="field-name"><span class="field-name">Sucursales</span></td>
                <td class="field-input"><input type="text" name="sucursales" class="autocomplete required"/></td>
            </tr>
            <tr>
    ...
    var abmCrear = function(){
        $.post(
            ...
            {   
                accion     : 'hacerAlta',
                parametros : {
                    almacenes     : $('input[name=almacenes]', 'table#abmCrear').val(),
                    desdeAlta     : false,
                    observaciones : $('textarea[name=observaciones]', 'table#abmCrear').val(),
                    sucursales    : $('input[name=sucursales]', 'table#abmCrear').attr('params'),
                    tipo          : 'almacenes'
                }
            }, 
            function(data){
