<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Actualizar comision</span>
        <!-- Tooltip -->
        <div class='tooltip'>
            <div class="tooltip-position" style='right: 30px; float: right;'>
                <img class="tooltip-click" src="img/ayuda.png" />
                <div class="tooltip-content" params="actualizarListasSubfamilias" style="top: 30px; left: -300px; width: 320px; height: 365px;"></div>
            </div>
        </div>
        <!-- Fin de la Tooltip -->
    </div>
                ...
                <td class="secundary" style="display: none; width: 720px; vertical-align: top;">
                    <div id="listas">
                        <table id="listas" align="left" style="width: 700px; margin-left: 10px;">
                            <thead>
                                <tr>
                                    <th class="detalles-titulo-dark">Marca.</th>
...
<div id="modal" class="resumen" style="display: none">
    <div class="modal_title"><span class="title">Actualizar Comision - Resumen</span></div>
...
<script type="text/javascript">
    ...
    var showSecundary = function(){
        ...
        var tdMarca = '<td params="'+$('input[name=marcas]').attr('params')+'">'+$('input[name=marcas]').val()+'</td>';
        ...
        tr = '<tr id="product_'+product_count+'" class="'+trClass+'">' +  tdMarca + tdImporte + tdSupr + '</tr>';
        trResumen = '<tr id="product_'+product_count+'" class="'+trClassResumen+'">' + tdMarca + tdImporte  +  '</tr>';
    ...
    var resetForm = function(){
        $('input[name=marcas]').val('');
        $('input[name=marcas]').attr('params', '');
    ...
    $('div.send-button.resumenAltaStock').click(function(){
        if(window.added < 1){
            ...
            if($('input#error', 'div#modal.inicio').val() == '0'){
                ...
                $('td.cabecera-detalle-blue.subfamilias').html($('input[name=subfamilias]').val());
    ...
    $('div.hacerAltaStock').click(function(){
        ...
        var params = {
            ...
            subfamilia    : $('input[name=subfamilias]', 'table#abmCrear').attr('params'),
            productos    : $('input[name=productos]').attr('params'),
            listas         : listasSplited,
            tipo              : 'actualizarComision'
        };
