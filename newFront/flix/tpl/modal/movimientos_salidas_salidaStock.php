...
<script type="text/javascript">
    ...
    var showSecundary = function(){
        ...
        if(existing_tr !== null) {
            ...
            var pt = (nueva_cantidad * rs.precio).toFixed(2);
            ...
            if(id_f != 'undefined'){
                $('tr', 'table#productos tbody').each(function(){
                    ...
                    if($(this).attr('id_f') == id_f){
                        ...
                        $('td.pt', tr)
                            .attr('value', (rs.precio * $('.editableCount', tr).val()).toFixed(2))
                            .text((rs.precio * $('.editableCount', tr).val()).toFixed(2));
                    }
                });
            }
        } else {
    ...
    var drawProduct = function(p){
        ...
        var tdPT    = '<td class="pt" value="'+(p.precio * p.cantidad).toFixed(2)+'">'+(p.precio * p.cantidad).toFixed(2)+'</td>';
    ...
    $('.editableCount').live('change', function(e){
        ...
        var pt   = ($(this).val() * ($('td.pu', el).html())).toFixed(2);
