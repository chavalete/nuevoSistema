<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Alta de departamentos</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <table id="abmCrear">
            ...
            <tr>
                ...
                <td class="field-input"><input class="required" type="text" name="provincias" /></td>
            </tr>
            <tr>
    ...
    var abmCrear = function(){
        ...
        $.post(
            ...
            {   
                accion     : 'hacerAlta',
                parametros : {
                    provincias    : $('input[name=provincias]', 'table#abmCrear').val(),
                    desdeAlta     : false,
