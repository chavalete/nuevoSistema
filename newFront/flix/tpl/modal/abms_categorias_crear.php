<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Alta de categorias</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <table id="abmCrear">
            ...
            <tr>
                ...
                <td class="field-input"><input class="required" type="text" name="categorias" /></td>
            </tr>
            <tr>
    ...
    var abmCrear = function(){
        ...
        $.post(
            ...
            {   
                accion     : 'hacerAlta',
                parametros : {
                    categorias    : $('input[name=categorias]', 'table#abmCrear').val(),
                    desdeAlta     : false,
