<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Cargar de cotización</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <table id="abmCrear">
            ...
            <tr>
                <td class="field-name"><span class="field-name">cotización</span></td>
                <td class="field-input"><input class="required" type="text" name="cotizacion" /></td>
            </tr>
            <tr>
    ...
    var abmCrear = function(){
        ...
        $.post(
            ...
            {   
                accion     : 'hacerAlta',
                parametros : {
                    cotizacion    : $('input[name=cotizacion]', 'table#abmCrear').val(),
                    desdeAlta     : false,
