<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Alta de sucursales</span>
        <!-- Tooltip -->
        <div class='tooltip'>
            <div class="tooltip-position">
                <img class="tooltip-click" src="img/ayuda.png" />
                <div class="tooltip-content" params="crear" style="top: 30px; left: -300px; width: 320px; height: 100px;"></div>
            </div>
        </div>
        <!-- Fin de la Tooltip -->          
    </div>
    <div class="modal_content">
        <table id="abmCrear">
            ...
            <tr>
                ...
                <td class="field-input"><input class="required" type="text" name="sucursales"/></td>
            </tr>
            <tr>
    ...
    var abmCrear = function(){
        $.post(
            ...
            {   
                ...
                parametros : {
                    desdeAlta     : false,
                    sucursales    : $('input[name=sucursales]', 'table#abmCrear').val(),
