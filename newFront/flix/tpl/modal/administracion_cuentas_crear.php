<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Alta de cuentas</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <table id="abmCrear">
            ...
            <tr>
                ...
                <td class="field-input"><input class="required" type="text" name="cuentas"/></td>
            </tr>
            <tr>
    ...
    var abmCrear = function(){
        $.post(
            ...
            {   
                accion     : 'hacerAlta',
                parametros : {
                    cuentaNombre     : $('input[name=cuentas]', 'table#abmCrear').val(),
                    desdeAlta     : false,
