...
<script type="text/javascript">
    $('div.send-button.exportarStock').click(function(){
        ...
        if($('input#error', 'div#modal.inicio').val() == '0'){
            $.colorbox.close();
            window.open("http://45.56.77.112/newFront/exportador/exportadorConsumoPorProducto.php?accion=hacerAlta&tipoReporte="+tipoReporte+"&fechaHasta="+fechaHasta+"&fechaDesde="+fechaDesde+"&subfamilias="+subfamilias+"&marcas="+marcas+"&idProducto="+productos+"&idVendedor="+vendedor+"&idCliente="+cliente, "_blank");
        }        
    });
</script>
