<table id="abmCrear">
    ...
    <tr>
        ...
        <td class="field-input"><input class="required" type="text" name="vendedor"/></td>
    </tr>
    <tr>
        <td class="field-name"><span class="field-name">Nro de Telefono</span></td>
        <td class="field-input"><input type="text" name="vendedorTelefono"/></td>
    </tr>
    <tr>
    ...
    var abmCrear = function(){
        ...
        $.post(
            ...
            {   
                ...
                parametros : {
                    desdeAlta        : false,
                    vendedores       : $('input[name=vendedor]', 'table#abmCrear').val(),
                    vendedorTelefono : $('input[name=vendedorTelefono]', 'table#abmCrear').val(),
                    vendedorMail     : $('input[name=vendedorMail]', 'table#abmCrear').val(),
