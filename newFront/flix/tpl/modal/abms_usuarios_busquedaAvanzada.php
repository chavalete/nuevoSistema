<div id="modal">
    <div class="modal_title">
        <span class="title">Busqueda avanzada de usuarios</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        ...
        <table>
            <tr>
                <td class="field-name"><span class="field-name">Usuarios</span></td>
                <td class="field-input"><input type="text" name="usuarios" class="autocomplete"/></td>
            </tr>
	    </tr>
        </table>
