<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Alta de relacion familias->subfamilias</span>
        <!-- Tooltip -->
        <div class='tooltip'>
                                ...
                                <td colspan="3">
                                    <table class="parcial">
                                        ...
                                        <tr>
                                            ...
                                            <td class="field-input"><input type="text" name="productosAbm" class="autocomplete parcial required"/></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="field-name"><span class="field-name">SubFamilias</span></td>
                                            <td class="field-input"><input type="text" name="subfamilias" class="autocomplete parcial required"/></td>
                                        </tr>
                                    </table>
                                <td>
                            </tr>
                        ...
                        <table id="listas" align="left" style="width: 700px; margin-left: 10px;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="detalles-titulo-dark">Familia.</th>
                                    <th class="detalles-titulo-dark">Subfamilia.</th>
...
<script type="text/javascript">
    ...
    var showSecundary = function(){
        ...
        var tdProd = '<td params="'+$('input[name=productosAbm]').attr('params')+'">'+$('input[name=productosAbm]').val()+'</td>';
        var tdFamilia = '<td params="'+$('input[name=familias]').attr('params')+'">'+$('input[name=familias]').val()+'</td>';
        var tdSubfamilia = '<td params="'+$('input[name=subfamilias]').attr('params')+'">'+$('input[name=subfamilias]').val()+'</td>';
        ...
        tr = '<tr id="product_'+product_count+'" class="'+trClass+'">' +  tdProd +  tdFamilia + tdSubfamilia + tdSupr + '</tr>';
        trResumen = '<tr id="product_'+product_count+'" class="'+trClassResumen+'">' + tdProd + tdFamilia + tdSubfamilia +  '</tr>';
    ...
    var resetForm = function(){
        $('input[name=familias]').val('');
        $('input[name=familias]').attr('params', '');
        $('input[name=subfamilias]').val('');
        $('input[name=subfamilias]').attr('params', '');
        $('input[name=precio]').val('');
        $('input[name=merma]').val('');
        $('input[name=lotes]').val('');
        $('input[name=fechaDesde]').val('');
        $('input[name=productosAbm]').focus();
        $('input[name=productosAbm]').val('');
        $('input[name=productosAbm]').attr('params', '');
    ...
    $('div.send-button.resumenAltaStock').click(function(){
        if(window.added < 1){
            ...
            if($('input#error', 'div#modal.inicio').val() == '0'){
                ...
                $('td.cabecera-detalle-blue.productosAbm').html($('input[name=productosAbm]').val());
    ...
    $('div.eliminar', 'table#listas').live('click', function(){
        ...
        $('input[name=subfamilias]').keypress(function(e){
        if(e.which == 13){
    ...
    $('div.hacerAltaStock').click(function(){
        ...
        var params = {
            ...
            relaciones         : listasSplited,
            tipo              : 'familiasSubfamilias'
        };
