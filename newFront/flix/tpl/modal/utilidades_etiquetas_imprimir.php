<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Imprimir Etiquetas</span>
        <!-- Tooltip -->
        <div class='tooltip'>
                                ...
                                <td colspan="3">
                                    <table class="parcial">
                                        ...
                                        <tr>
                                            ...
                                            <td class="field-input"><input type="text" name="productos" class="autocomplete parcial required"/></td>
                                        </tr>
                                        <tr>
                                        <td class="field-name"><span class="field-name">Tamaño</span></td>
                                        <td class="field-input">
                                            <select name="etiqueta">
                                                <option value="chico">Chico</option>
                                                <option value="mediado">Mediano</option>
                        ...
                        <table id="listas" align="left" style="width: 700px; margin-left: 10px;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="detalles-titulo-dark">Etiqueta.</th>
...
<div id="modal" class="resumen" style="display: none">
    <div class="modal_title"><span class="title">Imprimir Etiqeutas - Resumen</span></div>
    ...
    <div class="modal_content">
        ...
        <div style="margin-top: 10px; width: 100%; height: 395px; overflow: auto;">
            <table id="products_added" style="width: 100%;">
                <thead>
                    <th class="detalles-titulo-dark">Producto.</th>
                    <th class="detalles-titulo-dark">Tamaño.</th>
                </thead>
                <tbody></tbody>
            </table>
        </div>
...
<script type="text/javascript">
    ...
    var showSecundary = function(){
        ...
        var tdEtiqueta = '<td params="'+$('select[name=etiqueta]').val()+'">'+$('select[name=etiqueta]').text()+'</td>';
        ...
        tr = '<tr id="product_'+product_count+'" class="'+trClass+'">' +  tdProd +  tdEtiqueta+ tdSupr + '</tr>';
        trResumen = '<tr id="product_'+product_count+'" class="'+trClassResumen+'">' + tdProd + tdEtiqueta +  '</tr>';
    ...
    $('div.hacerAltaStock').click(function(){
        ...
        var params = {
            ...
            litado         : listasSplited,
            tipo              : 'imprimirEtiquetas'
        };
