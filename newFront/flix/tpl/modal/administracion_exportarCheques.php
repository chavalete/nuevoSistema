...
<script type="text/javascript">
    $('div.send-button.exportarStock').click(function(){
        ...
        if($('input#error', 'div#modal.inicio').val() == '0'){
            $.colorbox.close();
            window.open("http://172.104.5.168/limonLocal/exportador/exportadorCheques.php??accion=hacerAlta&tipoReporte="+tipoReporte+"&idImputacion="+imputacion+"&idEstado="+estado, "_blank");
        }        
    });
</script>
