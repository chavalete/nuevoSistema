<div id="modal" class="inicio">
    <div class="modal_title">
        <span class="title">Devolucion de caja</span>
        <!-- Tooltip -->
        <div class='tooltip'>
    ...
    <div class="modal_content">
        <table id="abmCrear">
            ...
            <tr>
                <td class="field-name"><span class="field-name">Motivo</span></td>
                <td class="field-input">
                    <select name="formaPagoId">
                        <option value="0">Seleccionar</option>
                        <option value="4">Diferencia de precio</option>
        ...
        $.post(
            ...
            {   
                ...
                parametros : {
                    ...
                    formaPagoId  : $('select[name=formaPagoId]').val(),
                    tipo          : 'devolucionDeCaja'
                }
            }, 
            function(data){
                window.rsAbm = data;
