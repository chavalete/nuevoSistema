<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/newFront/stock/SucursalAnmatExtendido.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/newFront/libreria/almacenamiento/FrenteAlmacenamiento.php';
/*
FRENTE PARA CARGAR LO QUE EL FRENTE requiera en cuanto a estetica y datos
*/

class FrenteSucursalesMensajeria
{
	...
	$this->_colSucursales[$id] = NEW SucursalAnmatExtendido();
...
//echo $db_dM->getQry();exit;
	...
	for($i=$primerRegistro;$i<$ultimoRegistro;$i++){   
	    $this->cargarSucursal($arr[$i]['id_sucursal']);
	}
    }
